...
from .sql_execution import QueryMixin  # Provides query and pandas_query methods
...
class Team(QueryBase, QueryMixin):
    ...
    def names(self):
        ...
        return self.query(query)  # Returns list of tuples like [(1, 'Team A'), ...]
    ...
    def username(self, id):
        ...
        return self.query(query)  # Returns list of tuples like [('Team A',)]
    ...
    def model_data(self, id):
        query = f"""
            SELECT positive_events, negative_events FROM (
                ...
                """
        return self.pandas_query(query)  # Returns a pandas DataFrame
